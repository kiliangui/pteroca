    ...
    <>
      ...
      <main className="flex container flex-col gap-2">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either {'"'}the Company{'"'}, {'"'}We{'"'}, {'"'}Us{'"'} or {'"'}Our{'"'} in this Agreement) refers to hostchicken.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to hostchicken, accessible from <a href="https://hostchicken.com" rel="external nofollow noopener" target="_blank">https://hostchicken.com</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: kilianguilloteaux@gmail.com</p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="https://hostchicken.com/contact" rel="external nofollow noopener" target="_blank">https://hostchicken.com/contact</a></p>
          </li>
        </ul>
      </main>
    </>
