...
final class Version20250217102648 extends AbstractMigration
{
    ...
    {
        $this->addSql('UPDATE setting SET context = \'pterodactyl_settings\' WHERE name IN (\'pterodactyl_panel_url\', \'pterodactyl_api_key\', \'pterodactyl_use_as_client_panel\', \'pterodactyl_sso_enabled\', \'pterodactyl_sso_secret\')');
        ...
        $this->addSql('UPDATE setting SET hierarchy = 10 WHERE name IN (\'pterodactyl_panel_url\', \'pterodactyl_api_key\')');
    ...
    {
        $this->addSql('UPDATE setting SET context = \'general_settings\' WHERE name IN (\'pterodactyl_panel_url\', \'pterodactyl_api_key\', \'ptero_use_as_client_panel\', \'pterodactyl_sso_enabled\', \'pterodactyl_sso_secret\')');
