...
final class Version20250125011948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('UPDATE setting SET context = "general_settings" WHERE name IN ("site_url", "site_title", "site_locale", "pterodactyl_panel_url", "pterodactyl_use_as_client_panel", "pterodactyl_api_key", "show_phpmyadmin_url", "phpmyadmin_url")');
